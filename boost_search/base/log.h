...
#define LOG(level, format, ...)              \
    switch (level)                           \
    {                                        \
    case bs_log_system::Level::Debug:           \
        LOG_DEBUG(format, ##__VA_ARGS__);    \
        break;                               \
    case bs_log_system::Level::Info:            \
        LOG_INFO(format, ##__VA_ARGS__);     \
        break;                               \
    case bs_log_system::Level::Warning:         \
        LOG_WARN(format, ##__VA_ARGS__);     \
        break;                               \
    case bs_log_system::Level::Error:           \
        LOG_ERROR(format, ##__VA_ARGS__);    \
        break;                               \
    case bs_log_system::Level::Critical:        \
